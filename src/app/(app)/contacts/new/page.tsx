            ...
            <ul className="items-center w-full text-sm font-medium text-neutral-900 bg-white border border-neutral-400 rounded-lg sm:flex dark:bg-neutral-700 dark:border-neutral-600 dark:text-white">
                <li className="w-full border-b border-neutral-400 sm:border-b-0 sm:border-r dark:border-neutral-600">
                    <div className="flex items-center ps-3">
                        <input id="customer" type="radio" defaultChecked value="customer" name="contacts_type" className="w-4 h-4 text-pink-500 bg-neutral-100 border-neutral-300 focus:ring-pink-500 dark:focus:ring-pink-500 dark:ring-offset-neutral-700 dark:focus:ring-offset-neutral-700 focus:ring-2 dark:bg-neutral-600 dark:border-neutral-500" />
                ...
                <li className="w-full border-b border-neutral-400 sm:border-b-0 sm:border-r dark:border-neutral-600">
                    <div className="flex items-center ps-3">
                        <input id="supplier" type="radio" value="supplier" name="contacts_type" className="w-4 h-4 text-pink-500 bg-neutral-100 border-neutral-300 focus:ring-pink-500 dark:focus:ring-pink-500 dark:ring-offset-neutral-700 dark:focus:ring-offset-neutral-700 focus:ring-2 dark:bg-neutral-600 dark:border-neutral-500" />
