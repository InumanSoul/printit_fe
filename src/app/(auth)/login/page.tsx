        ...
        <div className='p-5'>
          ...
          <form>
            ...
            <div className='mb-2 flex flex-col'>
              ...
              <input type='password' className='border border-gray-300 rounded-lg w-full p-2 focus:border-pink-400 outline-pink-400/50 outline-4 outline-offset-2' required/>
            </div>
            <div className='mb-2'>
